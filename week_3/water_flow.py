""""
Title: Water Flow Program for new Water System
Author: Clinton Jake Cai
Description: Computes the necessary water system formulas by having literal values to help design and install this new water system.
Enhancement: I added the two variable "WATER_DYNAMIC_VISCOSITY" and "EARTH_ACCELERATION_OF_GRAVITY" for ease of coding rather than hard coding it.
"""
